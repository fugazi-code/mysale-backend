        ...
        <div class="collapse navbar-collapse h-100" id="navbarNav">
            <div class="container h-100 d-flex justify-content-between">
                <ul class="navbar-nav h-100">
                    ...
                    <li class="nav-item">
                        <router-link class="nav-link h-100 pt-3 px-2" :to="{ name: 'home' }">Car and Bikes</router-link>
                    </li>
                    <li class="nav-item">
                        <router-link class="nav-link h-100 pt-3 px-2" :to="{ name: 'about' }">About</router-link>
                    </li>
                </ul>
                <ul class="navbar-nav h-100">
                    <li class="nav-item">
                        <router-link class="nav-link h-100 pt-3 px-2" :to="{ name: 'home' }">Log In</router-link>
                    </li>
                    <li class="nav-item">
                        <router-link class="nav-link h-100 pt-3 px-2" :to="{ name: 'home' }">Sign Up</router-link>
                    </li>
                    <li class="nav-item h-100 ms-2">
                        <button type="button" class="btn btn-info mt-2 text-white">Sell</button>
                    </li>
                </ul>
            </div>
        </div>
